    ...
    EventManagerAwareInterface
{
    ...
    public function __construct($configuration, ServiceManager $serviceManager)
    {
	    ...
	    $this->initURI		   = 'http://'.$this->httpHost.':'.$this->serverPort.'/application/index/index';
        ...
        $requestFilter=new Request();
        $requestFilter->setUri($this->initURI);
        $requestFilter->setRequestUri($this->initURI);
    ...
    public function bootstrap()
    {
        ...
        $request->setUri($this->initURI);
        $request->setRequestUri($this->initURI);
...
/*
        ...
        $_SERVER['REQUEST_URI']='/index/form';
        echo "--------->". $_SERVER['REQUEST_URI'];
        echo "<br><br>";
        /*
        */
    ...
    public function render($pathtoroute)
    {
    	$events = $this->getEventManager();
    	$event  = $this->getMvcEvent();
    	...
    	$request->setUri('http://'.$this->httpHost.':'.$this->serverPort.$pathtoroute);
      	$request->setRequestUri('http://'.$this->httpHost.':'.$this->serverPort.$pathtoroute);
    	$event->setRequest($request);
    	...
    	$events->trigger(MvcEvent::EVENT_FINISH, $event);
    	return $this->completeRequest($event)->getContent();;
