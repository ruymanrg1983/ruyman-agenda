...
function gridster_setup() {
	 ...
	 * to change 'gridster' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'gridster', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'gridster' ),
	) );
}
...
// Google Font
	wp_enqueue_style( 'open-sans-condensed', '//fonts.googleapis.com/css?family=Open+Sans+Condensed:300', 'style' );
